# -*- coding: utf-8 -*-
#
# jove_catalog documentation build configuration file
#
...
html_theme_options = dict(
    github_url='https://github.com/Pylons/jove_catalog',
#    in_progress='true'
    )
...
htmlhelp_basename = 'jove_catalog'
...
latex_documents = [
  ('index', 'jove_catalog.tex', 'jove_catalog Documentation',
